package com.dsn.documentscannerexample
...
import com.dsn.documentscannerexample.ui.theme.DocumentScannerExampleTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val options = GmsDocumentScannerOptions.Builder().setScannerMode(SCANNER_MODE_FULL)
            .setGalleryImportAllowed(true).setPageLimit(5)
